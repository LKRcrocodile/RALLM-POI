...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Retriever for CLSPRec experiments")
    parser.add_argument("--valid_hist_path", type=str, default="/home/xyliu/content/CLSPRec/experiments_rag/SIN_valid_short_term_history")
    parser.add_argument("--train_hist_path", type=str, default="/home/xyliu/content/CLSPRec/experiments_rag/SIN_train_short_term_history")
    parser.add_argument("--valid_rec_path", type=str, default="/home/xyliu/content/CLSPRec/experiments_rag/SIN_valid_short_term_recommendation")
    parser.add_argument("--train_rec_path", type=str, default="/home/xyliu/content/CLSPRec/experiments_rag/SIN_train_short_term_recommendation")
    parser.add_argument("--embed_method", type=str, default="bert", choices=["tfidf", "bert"])
    parser.add_argument("--similarity_metric", type=str, default="cosine", choices=["cosine", "euclidean", "dot_product"])
    parser.add_argument("--top_k", type=int, default=5)
    parser.add_argument("--search_k", action="store_true", help="Whether to search for the best k") # If this is set, top_k will be ignored
    ...
    if args.search_k:
        run_multiple_ks(
            valid_hist_path=args.valid_hist_path,
            train_hist_path=args.train_hist_path,
            valid_rec_path=args.valid_rec_path,
            train_rec_path=args.train_rec_path,
